...
- 2026-09-21 hero animation restored: restored the 21st.dev Living Topographic Elevation & Breathing Contour Waves Mesh Shader in apps/web/src/features/landing/ShaderAnimation.tsx over the warm sandstone/white canvas with interactive cursor deflection and luminous champagne highlights.
